...
import com.caitu99.lsp.parser.bank.minsheng.Minsheng;
 ...
 */
@Service("MinshengNormalCard")
public class NormalCard extends Minsheng implements ICard {
	
	@Autowired
    private AppConfig appConfig;

	@Value("${minsheng.normal.id}")
	private Integer id;

	@Value("${minsheng.normal.name}")
	private String name;

	@Value("${minsheng.normal.bill.type}")
	private int billType;

	@Value("${minsheng.normal.mail.key}")
	private String titleKey;

	@Value("${minsheng.normal.mail.sender}")
	private String mailSender;

	@Value("${minsheng.normal.history.bill}")
