...
import com.caitu99.lsp.parser.bank.jiaotong.Jiaotong;
 ...
 */
@Service("JiaotongNormalCard")
public class NormalCard extends Jiaotong implements ICard {
	
	@Autowired
    private AppConfig appConfig;

	@Value("${jiaotong.normal.id}")
	private Integer id;

	@Value("${jiaotong.normal.name}")
	private String name;

	@Value("${jiaotong.normal.bill.type}")
	private String billType;

	@Value("${jiaotong.normal.mail.key}")
	private String titleKey;

	@Value("${jiaotong.normal.mail.sender}")
	private String mailSender;

	@Value("${jiaotong.normal.history.bill}")
