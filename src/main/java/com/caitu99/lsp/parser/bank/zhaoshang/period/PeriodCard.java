...
@Service("ZhaoshangPeriodCard")
public class PeriodCard extends Zhaoshang implements ICard {
	
	@Autowired
    private AppConfig appConfig;

	@Value("${zhaoshang.period.id}")
	private Integer id;

	@Value("${zhaoshang.period.name}")
	private String name;

	@Value("${zhaoshang.period.bill.type}")
	private int billType;

	@Value("${zhaoshang.period.mail.key}")
	private String titleKey;

	@Value("${zhaoshang.period.mail.sender}")
	private String mailSender;

	@Value("${zhaoshang.period.history.bill}")
