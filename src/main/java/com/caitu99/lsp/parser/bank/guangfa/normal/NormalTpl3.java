...
@Template("guangfa.normal.tpl3")
public class NormalTpl3 extends BaseTpl {
    private final static Logger logger = LoggerFactory.getLogger(NormalTpl3.class);
    ...
    public boolean parse() {
        ...
        Elements fonts = trs.get(2).getElementsByTag("span");
        ...
        fonts = trs.get(2).getElementsByTag("span");
        fontCnt = fonts.size() - 1;
