...
import com.caitu99.lsp.parser.bank.zhongxin.Zhongxin;
import com.caitu99.lsp.parser.utils.BillHelper;
import com.caitu99.lsp.utils.SpringContext;

@Service("ZhongxinNormalCard")
public class NormalCard extends Zhongxin implements ICard {
	
	@Autowired
    private AppConfig appConfig;

	@Value("${zhongxin.normal.id}")
	private Integer id;

	@Value("${zhongxin.normal.name}")
	private String name;

	@Value("${zhongxin.normal.bill.type}")
	private int billType;

	@Value("${zhongxin.normal.mail.key}")
	private String titleKey;

	@Value("${zhongxin.normal.mail.sender}")
	private String mailSender;

	@Value("${zhongxin.normal.history.bill}")
