...
@Service("ZhaoshangNormalCard")
public class NormalCard extends Zhaoshang implements ICard {
	
	@Autowired
    private AppConfig appConfig;

	@Value("${zhaoshang.normal.id}")
	private Integer id;

	@Value("${zhaoshang.normal.name}")
	private String name;

	@Value("${zhaoshang.normal.bill.type}")
	private int billType;

	@Value("${zhaoshang.normal.mail.key}")
	private String titleKey;

	@Value("${zhaoshang.normal.mail.sender}")
	private String mailSender;

	@Value("${zhaoshang.normal.history.bill}")
