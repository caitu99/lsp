...
public class TaobaoEvent extends QueryEvent {
    ...
    private String sid;
    private TaobaoState state;

    public TaobaoEvent() {

    }

    public TaobaoEvent(String userid, DeferredResult<Object> deferredResult) {
        super(userid, deferredResult);
    }

    public TaobaoState getState() {
        return state;
    }

    public void setState(TaobaoState state) {
        this.state = state;
    }

    public void setException(Exception exception) {
        this.setState(TaobaoState.ERROR);
