 ...
 * @Copyright (c) 2015-2020 by caitu99
 */
public class YJF189ntSpiderEvent extends QueryEvent {
    ...
    private YJF189ntSpiderState state = YJF189ntSpiderState.NONE;

    public YJF189ntSpiderEvent() {

    }

    public YJF189ntSpiderEvent(String userId, DeferredResult<Object> deferredResult) {
    ...
    public void setException(Exception exception) {
        this.setState(YJF189ntSpiderState.ERROR);
     ...
     * @return 事件状态
     */
    public YJF189ntSpiderState getState() {
        return state;
    }
     ...
     * @param 事件状态 to set
     */
    public void setState(YJF189ntSpiderState state) {
        this.state = state;
    }
