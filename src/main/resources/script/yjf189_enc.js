...
function AESEncrypt(n) {
	var u = CryptoJS.AES.encrypt(n, "login.189.cn");
	
	return u + "";
};

function AESDecrypt(n) {
	var u = CryptoJS.AES.decrypt(n, "login.189.cn").toString(CryptoJS.enc.Utf8);
