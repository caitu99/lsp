...
function getTaoBaoEncryption(exponent, module, password) {
    TAOBAO.BigTools && TAOBAO.BigTools.setMaxDigits(130);
    var c = new TAOBAO.RSAKeyPair(exponent, "", module);
    return TAOBAO.RSAKeyPair.encryptedString(c, password);
}