...
function getQQEncryptionAlone(pwd, tsValue) {
    ...
    var RSA = new QQALONE.RSAKey();
    RSA.setPublic(PublicKey, "10001");
    var Res = RSA.encrypt(pwd + '\n' + tsValue + '\n');
    if (Res) {
        return QQALONE.hex2b64(Res);
    }
}
